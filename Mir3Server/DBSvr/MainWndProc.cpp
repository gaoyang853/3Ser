...
void OnCommand(WPARAM wParam, LPARAM lParam)
{
	...
	switch (LOWORD(wParam))
	{
		case IDM_STARTSERVICE:
		{
			...
			InitServerSocket(g_ssock, &g_saddr, _IDM_GATECOMMSOCK_MSG, 6000, 1);/*for server*/
			InitGateCommSocket(g_gssock, &g_gsaddr, _IDM_GATECOMMSOCK_MSG, 5100, FD_ACCEPT|FD_READ|FD_CLOSE);/*for gate*/
